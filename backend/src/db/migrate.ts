...
import * as migration003 from './migrations/003_dev_seed'
import * as migration004 from './migrations/004_refresh_tokens'
  ...
  const migrator = new Migrator({
    ...
    provider: {
      getMigrations: async () => ({
        ...
        '003_dev_seed': migration003,
        '004_refresh_tokens': migration004,
      }),
    },
  })
